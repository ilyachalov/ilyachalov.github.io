...
tags: [TCP, сетевое программирование]
---
...
![](/images/tcp-client-test-localhost.png)
...
![](/images/tcp-client-test-tcpbin-com.png)
...
**Дополнение от 16.01.2026 г.**: на днях тестировали со студентами работу TCP-клиента, написанного на языке C++ ([код взяли из документации](https://learn.microsoft.com/en-us/windows/win32/winsock/complete-client-code) библиотеки Winsock на сайте компании Microsoft). С этим клиентом добавлять при отправке символ `'\n'` новой строки в конец сообщения не понадобилось, всё работает успешно и без этого. Я так и не разобрался, почему эти TCP-клиенты по-разному взаимодействуют с сайтом tcpbin.com.
...
![](/images/tcp-client-test-tcpbin-net.png)
...
![](/images/tcp-client-test-tcpbin-net-browser.png)
...
![](/images/tcp-client-test-http.png)
