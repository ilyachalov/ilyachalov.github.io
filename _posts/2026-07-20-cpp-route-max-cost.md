...
tags: [C++, алгоритмы, динамическое программирование, нейросети, Яндекс.CodeRun]
---
...
> В левом верхнем углу прямоугольной таблицы размером `N`&nbsp;×&nbsp;`M` (размеры являются натуральными числами, не превосходящими 100) находится черепашка. В ячейках таблицы записаны целые числа. Черепашка перемещается **_только_** вправо или вниз, заканчивая свой маршрут в правом нижнем углу таблицы. Требуется подсчитать и вывести сумму чисел, через которые проползет черепашка, включая первую и последнюю ячейку маршрута; сумма должна быть **_максимально возможной_** в данной таблице. Также требуется вывести пошаговый маршрут черепашки с помощью символов `D` (вниз) и `R` (вправо), разделенных пробелом.
