---
layout: post
title: "C++: разложение на минимум простых слагаемых"
---
...
Функции `contains` и `decomposeOnPrimes` подробно описаны выше в этом посте. Класс `Timer` описан в [одном]({% post_url 2026-06-06-primes-array %}) из предыдущих постов. Функция `getPrimes` описана в [предыдущем посте]({% post_url 2026-06-06-primes-seive-eratosthenes %}).
