...
*Метки*&nbsp;— это более мелкозернистая классификация постов, чем категории. С технической точки зрения реализуются метки немного проще категорий. Если один пост обычно относят к одной категории (реже&nbsp;— к двум-трем), то количество меток у одного поста может быть сколько угодно, но обычно до десятка.
