...
tags: [C++, CMake, Google Test, тестирование программ]
---
...
Как видно на вышеприведенной иллюстрации, функция (модуль) `factorial` успешно прошла наш единственный на данный момент тест.
