...
tags: [TCP, Windows Defender Firewall, сетевое программирование]
---
...
- при общении TCP-клиента и TCP-сервера в рамках одного узла (компьютера) я использую имя сервера `localhost` или один из двух соответствующих IP-адресов: `127.0.0.1` или `::1`;
