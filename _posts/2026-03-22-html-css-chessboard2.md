...
В [одном]({% post_url 2026-03-18-html-css-chessboard %}) из предыдущих постов я описал создание веб-страницы с минималистичной версией шахматного поля. Проект писали со старшеклассниками, потом расширяли в течение нескольких занятий. Пока используем HTML и CSS, включая технологию Flexbox. JavaScript добавим позже. Вот как выглядел результат, скриншот ([онлайн](https://textpub.neocities.org/my/chess-board/v1/)):
