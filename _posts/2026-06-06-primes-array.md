...
В реализации я решил использовать не статический, а динамический массив. При этом я буду использовать класс `std::vector`, который в C++ используют чаще других альтернатив, если требуется работа с динамическим массивом.

## Функция проверки простоты числа

Эту функцию разбирал в [предыдущем посте]({% post_url 2026-05-27-primality-test %}) (она написана по алгоритму перебора делителей без каких-либо оптимизаций), вот код:
